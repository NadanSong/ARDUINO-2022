...
#define _SERVO_ANGLE_DIFF 1100 // Replace with |D - E| degree
#define _SERVO_SPEED 1000 // servo speed limit (unit: degree/second)

#define _BANGBANG_RANGE 90
...
// Replace the below line with the equation obtained from nonlinear regression analysis
  return ((0.00001*a_value*a_value*a_value)*(-1)) + (0.0144*a_value*a_value) - (7.001*a_value) + 1209.8;
}
